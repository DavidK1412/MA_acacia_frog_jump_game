...
func NewRouter(pingHandler *handler.PingHandler, nextMoveHandler *handler.NextMoveHandler, metricsHandler *handler.MetricsHandler) *Router {
	return &Router{
...
func (r *Router) Setup() http.Handler {
	...
	if r.metricsHandler != nil {
		r.muxRouter.HandleFunc("/v1/graph/metrics", r.metricsHandler.Handle).Methods("POST")
	}
